...
export const MODULES: Module[] = [
  {
    ...
    sections: {
      ...
      deepDive: "### Phân tích Biên lợi nhuận theo ngành\n- **Ngành Công nghệ (VD: Apple, Microsoft):** Thường có biên lợi nhuận gộp rất cao (40-60%) nhờ sở hữu trí tuệ và thương hiệu mạnh.\n- **Ngành Bán lẻ (VD: Walmart, Thế Giới Di Động):** Biên lợi nhuận gộp thường thấp (15-25%) nhưng bù lại bằng khối lượng bán hàng cực lớn.\n- **Ngành Sản xuất (VD: Hòa Phát):** Phụ thuộc lớn vào giá nguyên liệu đầu vào và quy mô sản xuất.\n\n**So sánh thực tế:** Biên lợi nhuận ròng của Apple thường duy trì trên 20%, trong khi các hãng bán lẻ như Walmart chỉ khoảng 2-3%.\n\n### 🔍 Case study thực chiến: Bóc tách Income Statement của Apple (FY2024)\nSố liệu làm tròn từ báo cáo năm tài chính 2024 của Apple:\n\n| Khoản mục | Số tiền (tỷ USD) |\n| :--- | ---: |\n| Doanh thu (Revenue) | 391 |\n| Giá vốn hàng bán (COGS) | 210 |\n| **Lợi nhuận gộp (Gross Profit)** | **181** |\n| Lợi nhuận ròng (Net Income) | 94 |\n\n**Tính tay từng bước:**\n1. Biên lợi nhuận gộp = Lợi nhuận gộp / Doanh thu = 181 / 391 = **~46%**.\n2. Biên lợi nhuận ròng = Lợi nhuận ròng / Doanh thu = 94 / 391 = **~24%**.\n\n**Đọc được gì?** Biên gộp 46% cho thấy sức mạnh định giá (pricing power) và thương hiệu cực mạnh — Apple bán sản phẩm cao hơn nhiều so với chi phí sản xuất. Việc giữ được tới 24% xuống tới lợi nhuận ròng chứng tỏ chi phí vận hành, R&D và thuế được kiểm soát rất tốt. Hãy thử tải ảnh báo cáo thật ở tab **Bài tập** và tự tính lại hai biên này.",
  ...
  },
  {
    ...
    sections: {
      ...
      deepDive: "### Cấu trúc vốn theo ngành\n- **Ngành Ngân hàng (VD: Vietcombank, JPMorgan):** Đặc thù là nợ phải trả rất lớn (tiền gửi của khách hàng) so với vốn chủ sở hữu. Tỷ lệ đòn bẩy thường rất cao.\n- **Ngành Bất động sản (VD: Vinhomes):** Thường có nợ vay lớn để tài trợ cho các dự án dài hạn. Khả năng thanh toán phụ thuộc vào tiến độ bán hàng.\n- **Ngành Công nghệ:** Thường có cấu trúc vốn 'nhẹ' (Asset-light), ít nợ vay và nhiều tiền mặt.\n\n**Phân tích rủi ro:** Một công ty BĐS có tỷ lệ Nợ/Vốn CSH > 2 lần thường được coi là rủi ro cao nếu thị trường đóng băng.\n\n### 🔍 Case study thực chiến: Đọc Balance Sheet của Microsoft (FY2024)\nSố liệu làm tròn từ bảng cân đối kế toán năm tài chính 2024 của Microsoft:\n\n| Khoản mục | Số tiền (tỷ USD) |\n| :--- | ---: |\n| Tổng tài sản (Assets) | 512 |\n| Nợ phải trả (Liabilities) | 244 |\n| **Vốn chủ sở hữu (Equity)** | **268** |\n\n**Tính tay từng bước:**\n1. Kiểm tra phương trình kế toán: Tài sản = Nợ + Vốn CSH → 244 + 268 = 512 ✅ (cân).\n2. Tỷ lệ Nợ/Vốn CSH (D/E) = 244 / 268 = **~0,91 lần**.\n\n**Đọc được gì?** D/E dưới 1,0 nghĩa là Microsoft tài trợ tài sản chủ yếu bằng vốn chủ sở hữu hơn là nợ — một bảng cân đối cực kỳ lành mạnh, đặc trưng của doanh nghiệp công nghệ 'asset-light'. So sánh: một công ty BĐS có thể có D/E 3-4 lần. Hãy tải ảnh Balance Sheet thật ở tab **Bài tập** và tự tính D/E của một công ty bạn quan tâm.",
  ...
  },
  {
    ...
    sections: {
      ...
      deepDive: "### Chỉ số đặc thù theo ngành\n- **Ngành Ngân hàng:** Tập trung vào NIM (Net Interest Margin), LDR (Loan to Deposit Ratio) và NPL (Non-Performing Loan).\n- **Ngành Bán lẻ:** Tập trung vào SSSG (Same Store Sales Growth) và Vòng quay hàng tồn kho.\n- **Ngành Công nghệ:** Tập trung vào CAC (Customer Acquisition Cost) và LTV (Lifetime Value) đối với các mô hình SaaS.\n\n**Lưu ý:** P/E của một công ty công nghệ tăng trưởng nhanh (như NVIDIA) thường cao hơn nhiều so với một công ty sản xuất truyền thống.\n\n### 🔍 Case study thực chiến: Phân tích DuPont ROE của Coca-Cola (KO)\nSố liệu minh họa làm tròn cho Coca-Cola:\n\n| Thành phần DuPont | Giá trị |\n| :--- | ---: |\n| Biên lợi nhuận ròng | 23% |\n| Vòng quay tài sản | 0,47 lần |\n| Đòn bẩy tài chính (Tài sản/Vốn CSH) | 3,8 lần |\n\n**Tính tay từng bước (ROE theo DuPont):**\n1. ROE = Biên LN ròng × Vòng quay tài sản × Đòn bẩy = 0,23 × 0,47 × 3,8 = **~41%**.\n\n**Đọc được gì?** ROE ~41% của KO trông rất ấn tượng, nhưng DuPont cho thấy động lực không chỉ đến từ kinh doanh hiệu quả (biên 23%) mà còn nhờ **đòn bẩy tài chính cao (3,8 lần)**. Nếu chỉ nhìn ROE mà bỏ qua đòn bẩy, bạn dễ đánh giá sai mức rủi ro. Đây chính là lý do phải mổ xẻ ROE thành 3 phần thay vì nhìn con số tổng.",
  ...
  },
  {
    ...
    sections: {
      ...
      deepDive: "### Định giá theo ngành đặc thù\n- **Ngành Công nghệ tăng trưởng:** Thường dùng P/S (Price to Sales) hoặc EV/EBITDA vì lợi nhuận giai đoạn đầu có thể thấp do chi phí đầu tư lớn.\n- **Ngành Sản xuất/Bất động sản:** Thường dùng P/B (Price to Book Value) để xem giá cổ phiếu so với giá trị tài sản ròng trên sổ sách.\n- **Ngành Tiêu dùng ổn định:** Thường dùng mô hình chiết khấu cổ tức (DDM).\n\n### 🔍 Case study thực chiến: P/E Forward & PEG của NVIDIA (NVDA)\nSố liệu minh họa để luyện tư duy định giá tăng trưởng:\n\n| Chỉ số | Giá trị |\n| :--- | ---: |\n| P/E hiện tại (trailing) | 80 lần |\n| EPS dự kiến năm tới | gấp 2 lần năm nay |\n| Tăng trưởng lợi nhuận kỳ vọng | 50%/năm |\n\n**Tính tay từng bước:**\n1. EPS dự kiến gấp đôi → P/E Forward = P/E hiện tại / 2 = 80 / 2 = **40 lần**.\n2. PEG = P/E Forward / Tốc độ tăng trưởng = 40 / 50 = **0,8**.\n\n**Đọc được gì?** P/E 80 nhìn 'đắt khủng khiếp', nhưng khi soi qua lăng kính tương lai thì P/E Forward chỉ còn 40, và PEG = 0,8 (< 1) lại hàm ý cổ phiếu **không hề đắt so với tốc độ tăng trưởng**. Bài học: với cổ phiếu tăng trưởng, đừng kết luận 'đắt/rẻ' chỉ bằng P/E quá khứ — luôn đối chiếu với tăng trưởng kỳ vọng.",
  ...
  },
  {
    ...
    sections: {
      ...
      deepDive: "### Phân tích Tập đoàn đa ngành (Conglomerate)\n- **Ưu điểm:** Đa dạng hóa nguồn thu, giảm rủi ro từ một ngành duy nhất.\n- **Nhược điểm:** Khó phân tích chính xác, rủi ro từ các mảng kinh doanh kém hiệu quả kéo lùi mảng tốt.\n- **Phương pháp SOTP (Sum-of-the-Parts):** Định giá riêng từng mảng kinh doanh rồi cộng lại để ra giá trị toàn tập đoàn.\n\n### 🔍 Case study thực chiến: Định giá SOTP cho tập đoàn đa ngành (kiểu Vingroup)\nVí dụ minh họa cách cộng giá trị từng mảng (số giả định để luyện phương pháp):\n\n| Mảng kinh doanh | Giá trị ước tính (tỷ VNĐ) |\n| :--- | ---: |\n| Bất động sản (Vinhomes) | 250.000 |\n| Công nghiệp (VinFast) | 120.000 |\n| Bán lẻ & dịch vụ khác | 30.000 |\n| (−) Nợ ròng toàn tập đoàn | (80.000) |\n| **Giá trị vốn chủ sở hữu (SOTP)** | **320.000** |\n\n**Tính tay từng bước:**\n1. Cộng giá trị các mảng: 250.000 + 120.000 + 30.000 = 400.000.\n2. Trừ nợ ròng: 400.000 − 80.000 = **320.000 tỷ VNĐ**.\n\n**Đọc được gì?** Với tập đoàn đa ngành, không thể dùng một chỉ số P/E duy nhất vì mỗi mảng có đặc thù và mức rủi ro khác nhau (BĐS tạo dòng tiền, VinFast 'đốt tiền' nhưng đột phá). SOTP buộc bạn định giá riêng từng mảng rồi trừ nợ — bức tranh sát thực hơn nhiều. Đây là bài tổng kết: hãy kết hợp cả 3 báo cáo + định giá để ra quyết định cuối cùng.",
